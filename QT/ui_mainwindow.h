...
public:
    ...
    QTableWidget *souvenirtablewidget;
    QPushButton *calculateSouvbtn;
    QPushButton *Clearsouv;
    QLabel *label;
    QPushButton *Backbttotrip;
    QWidget *TripSelect;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        souvenirtablewidget = new QTableWidget(SouvenirTrip);
        souvenirtablewidget->setObjectName(QString::fromUtf8("souvenirtablewidget"));
        souvenirtablewidget->setGeometry(QRect(45, 11, 681, 341));
        calculateSouvbtn = new QPushButton(SouvenirTrip);
        calculateSouvbtn->setObjectName(QString::fromUtf8("calculateSouvbtn"));
        calculateSouvbtn->setGeometry(QRect(50, 370, 141, 32));
        Clearsouv = new QPushButton(SouvenirTrip);
        Clearsouv->setObjectName(QString::fromUtf8("Clearsouv"));
        Clearsouv->setGeometry(QRect(530, 370, 131, 32));
        label = new QLabel(SouvenirTrip);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(250, 380, 91, 16));
        Backbttotrip = new QPushButton(SouvenirTrip);
        Backbttotrip->setObjectName(QString::fromUtf8("Backbttotrip"));
        Backbttotrip->setGeometry(QRect(261, 450, 231, 32));
        ...
        select_done->setGeometry(QRect(120, 450, 93, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Clearsouv->setText(QCoreApplication::translate("MainWindow", "Clear", nullptr));
        label->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
        Backbttotrip->setText(QCoreApplication::translate("MainWindow", "Back", nullptr));
        ...
        traversals_button->setText(QCoreApplication::translate("MainWindow", "Traversals", nullptr));
