...
/** \enum stadiums
 *  Enum type to identify the stadium on the graph using the team name
 */
enum stadiums
{
    ArizonaDiamondbacks,
...
public:
    ...
    void updateMlb(QString team, QString stadium, QString capacity,QString location, QString surface,
                               QString league,QString date,QString dtc, QString typo,QString roof,QString prevstadium);
    ...
    /** \fn getStadiumCount()
     * This function will calculate the total number of stadiums in the database using QSqlQuery qry. It will
     * return int stadiumCount at the end of the function.
     * @param no formal parameters
     * @return int stadiumCount
     */
    int getStadiumCount();

    /** \fn getStadiumName(stadiums stadium)
     * This function will retrieve the name of the stadium name of the corresponding team name enum identifer.
     * return QString staName at the end of the function.
     * @param stadiums stadium
     * @return int staName
     */
    QString getStadiumName(stadiums stadium);

    /** \fn getEnum(QString stadium)
     * This function will retrieve the enum value corresponding to the stadium name passed in.
     * @param QString stadium
     * @return stadiums stadium
     */
    stadiums getEnum(QString stadium);

    /** \fn getStadiumNameWithTeam(QString team)
     * This function load the name of the stadium corresponding the team name using the QSqlQueryModel model
     * and the QSqlQuery qry. If the value is not present in the database, then an error message will appear
     * @param QString team
     * @return QString staName
     */
    QString getStadiumNameWithTeam(QString team);

    /** \fn getTeamNameWithStadium(QString staName)
     * This function load the name of the team corresponding the stadium name using the QSqlQueryModel model
     * and the QSqlQuery qry. If the value is not present in the database, then an error message will appear
     * @param QString staName
     * @return QString teamName
     */
    QString getTeamNameWithStadium(QString staName);

    /** \fn loadpass()
     * Load the pass values that allow the user to enter the fan or admin sides of the program corresponding to
     * the user's login
     * @param no formal parameters
     * @return nothing returned
     */
