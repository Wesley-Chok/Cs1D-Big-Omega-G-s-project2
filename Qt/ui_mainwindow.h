...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        spinBoxDollar2->setMaximum(1000);
        ...
        prevstadiumlbl = new QLabel(stadiuminfopage);
        prevstadiumlbl->setObjectName(QString::fromUtf8("prevstadiumlbl"));
        prevstadiumlbl->setGeometry(QRect(540, 40, 58, 16));
